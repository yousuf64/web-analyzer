...
func (b *MessageBus) PublishJobUpdate(m JobUpdateMessage) {
...
func (b *MessageBus) PublishTaskStatusUpdate(m TaskStatusUpdateMessage) {
...
func (b *MessageBus) PublishSubTaskStatusUpdate(m SubTaskStatusUpdateMessage) {
...
func (b *MessageBus) SubscribeToJobUpdate(handler func(m *nats.Msg)) {
	b.nc.Subscribe(string(JobUpdateMessageType), handler)
}

func (b *MessageBus) SubscribeToTaskStatusUpdate(handler func(m *nats.Msg)) {
	b.nc.Subscribe(string(TaskStatusUpdateMessageType), handler)
}

func (b *MessageBus) SubscribeToSubTaskStatusUpdate(handler func(m *nats.Msg)) {
	b.nc.Subscribe(string(SubTaskStatusUpdateMessageType), handler)
}
